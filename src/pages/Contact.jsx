        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-400 focus:border-transparent transition-colors duration-300"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-400 focus:border-transparent transition-colors duration-300 resize-none"
                ...
                <button
                  type="submit"
                  className="w-full bg-red-400 hover:bg-red-500 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 hover:-translate-y-1 transform shadow-lg"
                >
                  Send Message
                </button>
              </form>
            ...
            <div className="space-y-8">
              ...
              {/* Social Media */}
              <div className="bg-gradient-to-r from-red-400 to-pink-400 rounded-xl shadow-lg p-8 text-white text-center">
                <h3
                ...
                <div className="flex justify-center space-x-4">
                  <button className="bg-white bg-opacity-20 hover:bg-opacity-30 p-3 rounded-full transition-all duration-300">
                    📘
                  </button>
                  <button className="bg-white bg-opacity-20 hover:bg-opacity-30 p-3 rounded-full transition-all duration-300">
                    📷
